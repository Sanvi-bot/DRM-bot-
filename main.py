...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6866402557:AAF8bn2Gm05kAAjd-1nxngfORYuD_NcNpE4")
    API_ID = int(os.environ.get("API_ID",  26721810))
    API_HASH = os.environ.get("API_HASH", "40be0b67b15513fc317a80399be79f2d")
